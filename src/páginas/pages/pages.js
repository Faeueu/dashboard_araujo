...
import { sum, aggVendas, margemPorCat, ticketSemanal, recSemanal, semanas,
         aggRupturas, coberturaFaixas, statusEstoque, statusPorCat } from '../utils/filters.js';
...
export class P1_VisaoGeral {
  render(el) {
    el.innerHTML = `
      ...
      <div id="p1-fbar" class="filter-zone"></div>
...
export class P2_Ticket {
  render(el) {
    el.innerHTML = `
      ...
      <div id="p2-fbar" class="filter-zone"></div>
...
export class P3_Margem {
  render(el) {
    el.innerHTML = `
      ...
      <div id="p3-fbar" class="filter-zone"></div>
      <div class="grid g4 mb">
...
export class P4_Estoque {
  render(el) {
    el.innerHTML = `
      ...
      <div id="p4-fbar" class="filter-zone"></div>
      <div class="grid g4 mb">
...
export class P5_Rupturas {
  render(el) {
    el.innerHTML = `
      ...
      <div id="p5-fbar" class="filter-zone"></div>
      <div class="grid g4 mb">
...
export class P6_Metas {
  render(el) {
    el.innerHTML = `
      ...
      <div id="p6-fbar" class="filter-zone"></div>
      <div class="grid g3 mb">
