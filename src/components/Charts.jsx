...
export function LineChart({ labels, datasets, yFmt, yMin, yMax, legend = false, maxT = 6, height }) {
  ...
  const options = {
    ...
    fill: {
      ...
      gradient: {
        shade: 'dark', type: 'vertical', shadeIntensity: 0,
        opacityFrom: c.isDark ? 3 : 5, opacityTo: 1,
        stops: [0, 85, 100], inverseColors: false,
      },
    },
    ...
    legend: {
      ...baseTheme.legend, show: legend, position: 'top',
      markers: { width: 16, height: 3, radius: 2 },
      itemMargin: { horizontal: 14 },
    },

    tooltip: {
      ...baseTheme.tooltip, shared: true, intersect: false,
