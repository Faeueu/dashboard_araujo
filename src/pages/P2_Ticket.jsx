  ...
  const hc = v => {
    ...
    if (c.isDark) {
      ...
      if (t < 0.5) {
        const s = t * 2;
        return {
          bg: `rgb(${Math.round(139 + s * 50)},${Math.round(30 + s * 40)},${Math.round(30 + s * 40)})`,
          text: '#fff',
        };
      }
      const s = (t - 0.5) * 2;
      return {
        bg: `rgb(${Math.round(189 + s * 50)},${Math.round(70 + s * 80)},${Math.round(70 + s * 30)})`,
        text: '#fff',
      };
    }
    // Light mode
    if (t < 0.5) {
      const s = t * 2;
      return {
        bg: `rgb(${Math.round(220 + s * 10)},${Math.round(38 + s * 60)},${Math.round(38 + s * 60)})`,
        text: '#fff',
      };
    }
    const s = (t - 0.5) * 2;
    return {
      bg: `rgb(${Math.round(230 + s * 25)},${Math.round(98 + s * 130)},${Math.round(98 + s * 130)})`,
      text: '#1e293b',
    };
  };
